...
public abstract class EditDeleteArrayAdapter<T> extends ArrayAdapter<T> implements View.OnClickListener {
    ...
    private OnEditButtonClickListener<T> mOnEditButtonClickListener;
    private OnDeleteButtonClickListener<T> mOnDeleteButtonClickListener;

    public EditDeleteArrayAdapter(
            Context context,
            List<T> entries,
            OnEditButtonClickListener<T> onEditButtonClickListener,
            OnDeleteButtonClickListener<T> onDeleteButtonClickListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView =
                    LayoutInflater.from(getContext()).inflate(R.layout.edit_delete_row, parent, false);
            ...
            viewHolder.restrictionKeyText = (TextView) convertView.findViewById(R.id.restriction_key);
        } else {
    ...
    public void onClick(View view) {
        ...
        @SuppressWarnings("unchecked") final RowViewHolder<T> viewHolder = (RowViewHolder<T>) ((View) parentView).getTag();
