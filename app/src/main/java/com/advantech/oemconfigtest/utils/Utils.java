package com.advantech.oemconfigtest.utils;
...
public class Utils {
    ...
    public static boolean isManagedProfileOwner(Context context) {
        ...
        if (Utils.SDK_INT >= VERSION_CODES.N) {
            try {
    ...
    public static boolean isDelegatedApp(Context context) {
        if (Utils.SDK_INT < VERSION_CODES.O) {
            return false;
        }
    ...
    public static boolean isDeviceManagementRoleHolder(Context context) {
        if (Utils.SDK_INT < VERSION_CODES.S) {
            return false;
        }
    ...
    public static Intent getLauncherIntent(Context context) {
        ...
        if (Utils.isRunningOnTvDevice(context)) {
